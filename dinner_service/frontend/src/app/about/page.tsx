      ...
      <main className="max-w-[1100px] mx-auto px-6 py-16">
        <section className="mb-16">
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-5xl font-bold text-stone-900 mb-4">미스터 대박을 소개합니다</h1>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-white rounded-3xl shadow-lg p-8 border border-amber-100">
              <h2 className="text-2xl font-semibold text-amber-800 mb-4">우리의 철학</h2>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 border border-amber-100">
              <h2 className="text-2xl font-semibold text-amber-800 mb-4">서비스 하이라이트</h2>
              <div className="space-y-5">
                <div>
                  <h3 className="text-lg font-semibold text-stone-900">프리미엄 코스 구성</h3>
                  <p className="text-sm text-stone-600 leading-relaxed">
                    발렌타인, 프렌치, 잉글리시, 샴페인 디너 등 4가지 대표 코스와 함께 시즌 한정 메뉴를 선보입니다.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-stone-900">AI &amp; 음성 주문</h3>
                  <p className="text-sm text-stone-600 leading-relaxed">
                    AI 추천과 음성 주문 기능을 통해 고객은 손쉽게 자신에게 맞는 메뉴를 선택할 수 있습니다.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-stone-900">맞춤 케이크</h3>
                  <p className="text-sm text-stone-600 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-amber-100 overflow-hidden">
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-10">
                <h2 className="text-2xl font-semibold text-amber-800 mb-4">셰프팀을 소개합니다</h2>
                <p className="text-stone-600 leading-relaxed mb-4">
        ...
        <section className="bg-white rounded-3xl shadow-lg border border-amber-100 p-10">
          <h2 className="text-2xl font-semibold text-amber-800 mb-6">고객과의 약속</h2>
          <div className="grid gap-6 md:grid-cols-3">
            <div className="p-6 border border-amber-100 rounded-2xl bg-amber-50/30">
              <h3 className="text-lg font-semibold text-stone-900 mb-2">고품질 재료</h3>
              <p className="text-sm text-stone-600 leading-relaxed">
                정기적으로 갱신되는 공급망과 셰프의 검수를 통해, 항상 신선하고 믿을 수 있는 재료만 사용합니다.
              </p>
            </div>
            <div className="p-6 border border-amber-100 rounded-2xl bg-amber-50/30">
              <h3 className="text-lg font-semibold text-stone-900 mb-2">투명한 가격</h3>
              <p className="text-sm text-stone-600 leading-relaxed">
                모든 재료와 메뉴 가격은 관리자 대시보드에서 투명하게 관리되며, 고객에게도 명확히 안내됩니다.
              </p>
            </div>
            <div className="p-6 border border-amber-100 rounded-2xl bg-amber-50/30">
              <h3 className="text-lg font-semibold text-stone-900 mb-2">정성 어린 서비스</h3>
              <p className="text-sm text-stone-600 leading-relaxed">
